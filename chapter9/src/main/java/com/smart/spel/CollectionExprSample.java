...
public class CollectionExprSample {
    ...
    public static void testCollection(){
        ...
        System.out.println(expressionParser.parseExpression("interestsList[0]").getValue(evaluationContext, String.class));
        System.out.println("<=============================>");
        System.out.println(expressionParser.parseExpression("placeOfBirth?.city").getValue(evaluationContext, String.class));
        System.out.println("<=============================>");
        System.out.println(expressionParser.parseExpression("interestsMap['interest1']").getValue(evaluationContext, String.class));
        System.out.println("<=============================>");
        System.out.println(expressionParser.parseExpression("userName").getValue(evaluationContext, String.class));
        System.out.println("<=============================>");
        expressionParser.parseExpression("interestsList={'Python','JS'}").getValue(evaluationContext);
        System.out.println(expressionParser.parseExpression("interestsList[0]").getValue(evaluationContext, String.class));
        System.out.println("<=============================>");
        expressionParser.parseExpression("interestsMap={userName:'tom',credits:100 }").getValue(evaluationContext);
        System.out.println(expressionParser.parseExpression("interestsMap['userName']").getValue(evaluationContext, String.class));
    }
}
