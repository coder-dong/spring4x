...
public class UserService extends BaseService {
    ...
    public static void main(String[] args) {
        ...
        //插入一条记录，初始分数为10
        jdbcTemplate.execute("INSERT INTO t_user(user_name,password,score,last_logon_time) VALUES('tom_2','123456',10," + System.currentTimeMillis() + ")");
        ...
        jdbcTemplate.execute("DELETE FROM t_user WHERE user_name='tom_2'");
    }
}
